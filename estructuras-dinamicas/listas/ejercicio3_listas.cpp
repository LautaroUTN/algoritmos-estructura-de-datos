...
void insertar(NodoLista *&lista,Estudiante est)
{
    ...
    //COMO ORDENAMOS ALFABETICAMENTE PONEMOS AL NOMBRE DEL ESTUDIANTE COMO STRING
    //NO COMO CHAR. SI USAMOS CHAR TENEMOS QUE USAR LA FUNCIÓN str_copy
    while(r!=NULL && r->est.nombre< est.nombre)
    {
        ant=r;
        r=r->sig;
    }
...
void stock( NodoLista *&pila, Estudiante estud )
{
    NodoLista*p=pila;
    estud=p->est;
    pila=p->sig;
